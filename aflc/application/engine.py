...
class ExecutionEngine:
    ...
    def record_observation(
        ...
        """Record an observation in execution."""
        return self.process_use_case.record_observation(
    ...
    def record_finding(
        ...
        """Record a finding in execution."""
        return self.process_use_case.record_finding(
            execution_id=execution_id,
            source=source,
            score=score,
    ...
    def evaluate_risk(
        ...
        return self.process_use_case.evaluate_risk(
            execution_id=execution_id,
